                                ...
                                <>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            Toque em <strong>Mais opções</strong> ou <strong>Configurações</strong> e selecione <strong>Dispositivos conectados</strong>
                                        </p>
                                        <p className="text-sm text-gray-600">
                                    ...
                                    <div className="mt-4 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                                        ...
                                        <p className="text-sm text-yellow-800">Aguardando conexão...</p>
                                    </div>
                                </>
                            ) : (
                                <div className="py-8">
