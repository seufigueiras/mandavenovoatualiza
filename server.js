...
const GEMINI_MODELS = [
  'gemini-2.0-flash-exp',    // Modelo mais novo com suporte a áudio
...
app.listen(PORT, () => {
  ...
  console.log(`🤖 Gemini: ${GEMINI_API_KEY ? '✅ Ativo' : '❌ Inativo'}`);
  console.log(`🎤 Suporte a Áudio: ✅ ATIVO (Modelos Multimodais 2.0/2.5)`);
  console.log(`🔧 Modelos: ${GEMINI_MODELS.join(', ')}`);
